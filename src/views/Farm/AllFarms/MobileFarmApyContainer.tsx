...
export const MobileFarmApyContainer: React.FC<{ data?: any, onclick: any }> = ({ data, onclick }) => {
    ...
    const LoanSwitch0Click = async () => {
        ...
        setLoanSwitch1(false);
        setFarm_Apr(null);
        setTrading_Free(null)
        setRABBIT_Rewards(null);
        setBorrow_Apr(null);
        setTotal_Apr(null);
        setDaily_Apr(null)
        //Cake/MDX年化收益率
